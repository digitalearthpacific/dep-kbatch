...
def main():
    ...
    search = catalog.search(
        ...
        query={"eo:cloud_cover": {"lt": 40}}, #cloudcover_percentage
    )
    ...
    evi.rio.to_raster("evi_{country_name}.tif", driver="COG")
    with open("evi_{country_name}.tif", "rb") as f:
        container_client.upload_blob(
            f"/evi/{country_name}.tif", f, overwrite=True
        )
